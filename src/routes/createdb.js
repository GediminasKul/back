...
const createNewDb = express.Router();

createNewDb.post('/Database/pets', async (req, res) => {
  let conn;
  try {
...
createNewDb.post('/Database/logs', async (req, res) => {
  let conn;
  try {
    conn = await mysql.createConnection(dbConfig);
...
createNewDb.post('/Database/prescriptions', async (req, res) => {
  let conn;
  try {
    conn = await mysql.createConnection(dbConfig);
